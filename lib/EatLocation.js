...
EatLocation.prototype.add = function() {
    ...
    // Here we check that there is no location with the same name.
    var locationExistsCallback = function(error, existingLocations) {
        ...
        return this.eat.getEatLocationSubscription().checkIsNotSubscribed(loc.user, subscriptionExistsCallback);
    }.bind(this);

    // Here we check that the user don't have any previous subscription.
