...
var EatUsers = {
    ...
    addUserRegid : function() {
        ...
        var userObj = {
            name : Eat.getParam('name', EatUsers.attrs.name.validation),
            email : Eat.getParam('email', EatUsers.attrs.email.validation),
            gcmregid : Eat.getParam('gcmregid', EatUsers.attrs.gcmregid.validation, EatUsers.attrs.gcmregid.pattern)
        };
    ...
    updateRegid : function() {
        EatUsers.fetchUser({_id : Eat.getUserid()}, function(error, user) {
            ...
            user.gcmregid = Eat.getParam(
                'gcmregid',
                EatUsers.attrs.gcmregid.validation,
                EatUsers.attrs.gcmregid.pattern
            );
