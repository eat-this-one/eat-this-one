...
function EatLocationSubscriptions(eat) {
...
EatLocationSubscriptions.prototype.get = function() {
...
EatLocationSubscriptions.prototype.add = function() {
...
EatLocationSubscriptions.prototype.checkIsNotSubscribed = function(userid, callback) {
 ...
 * @private
 */
EatLocationSubscriptions.prototype.save = function(subscription, callback) {
 ...
 * @private
 */
EatLocationSubscriptions.prototype.fetch = function(filters, callback) {
...
EatLocationSubscriptions.prototype.getEatLocation = function() {
    if (this.eatLocation === null) {
        var EatLocations = require('./EatLocations.js');
        this.eatLocation = new EatLocations(this.eat);
    }
    return this.eatLocation;
};

module.exports = EatLocationSubscriptions;
