$.eatLang.ca = {
    ...
    dishaddednomembersinfo : 'Ets l\'únic membre del grup! Convida als companys amb qui vols compartir el plat a unir-se al teu grup',
    ...
    invitejoindetailsbook1 : 'Uneix-te al meu grup',
    invitejoindetailsbook2 : 'a http://eat-this-one.com per veure els detalls i reservar una porció',
    invitejoinmygroup1 : 'Hola, uneix-te al meu grup',
    invitejoinmygroup2 : 'a http://eat-this-one.com per compartir dinars a la feina o a la universitat',
    ...
    loading : 'Carregant',
    membersince : 'Membre del grup des del',
    menu : 'Menú',
    message : 'Missatge',
    missingfields : 'Ey!',
    ...
    tipsubmit : 'Prem per desar',
    tipshare : 'Convidar companys',
    today : 'Avui',
    tomorrow : 'Demà',
