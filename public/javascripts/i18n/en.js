$.eatLang.en = {
    ...
    dishaddedfirstinvites : 'Now you can invite people to join your group',
    ...
    users : 'users',
    weird : 'Something weird happened in the server... try again in a while please',
    when : 'When',
